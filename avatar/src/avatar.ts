...
export class Avatar extends RawBounds {
    ...
    static async load(): Promise<Avatar> {
        const images = await Promise.all([
            loadImage("avatar/assets/idle.png"),
            loadImage("avatar/assets/talk.png"),
            loadImage("avatar/assets/xd.png"),
            loadImage("avatar/assets/xdTalk.png"),
            loadImage("avatar/assets/wheeze.png"),
            loadImage("avatar/assets/pog.png"),
        ]);
